...
`STS Sync` 是一个本地命令行工具，用于在 Windows PC 与 Android 平板之间，通过 ADB 半自动同步《杀戮尖塔 1》（Slay the Spire 1）存档。
...
1. 从 [Android SDK Platform Tools](https://developer.android.com/tools/releases/platform-tools) 下载 Windows 版本
2. 解压到例如 `D:\tools\platform-tools`
...
```text
backups/
└── 2026-04-05_213000_pull-progress/
    ├── pre/
    │   ├── android/
    │   │   └── preferences/
    │   └── pc/
